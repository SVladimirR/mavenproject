...
class MethodArrayCheckTest {
    ...
    @Test
    void arrayCheckingElements_3() {
        assertArrayEquals(new int[]{2, 2, 3, 1, 7}, new MethodArrayCheck().arrayCheckingElements(new int[]{1, 4, 2, 2, 3, 1, 7}, 4));
    }

    @Test
    void arrayCheckingElements_4() {
